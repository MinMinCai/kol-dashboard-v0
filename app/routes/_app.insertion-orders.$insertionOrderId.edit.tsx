...
export default function InsertionOrderEditPage() {
  ...
  const [titleVal, setTitleVal] = useState(insertionOrder.title ?? insertionOrder.orderTitle ?? "");
  const [clientNameVal, setClientNameVal] = useState(insertionOrder.clientName ?? "");
  const [industryVal, setIndustryVal] = useState(insertionOrder.industry ?? "");
