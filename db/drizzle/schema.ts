...
export const kols = pgTable(
  "kols",
  {
    ...
    contact: jsonb("contact").$type<{ phone?: string; email?: string; lineId?: string; manager?: string }>().default({}),
...
export const proposalKols = pgTable(
  "proposal_kols",
  {
    ...
    realFollowerRatio: numeric("real_follower_ratio", { precision: 5, scale: 2 }),
    ...
    engagementIndex: numeric("engagement_index", { precision: 6, scale: 3 }),
    engagementScore: numeric("engagement_score", { precision: 4, scale: 2 }),
    brandFitScore: numeric("brand_fit_score", { precision: 4, scale: 2 }),
    qualityScore: numeric("quality_score", { precision: 5, scale: 2 }),
    cpfr: numeric("cpfr", { precision: 10, scale: 4 }),
