...
function MantineClasses() {
  ...
  const classes45 = keys(theme.breakpoints).reduce((acc, breakpoint) => {
...
"use client";
function useProps(component, defaultProps101, props) {
  const theme = useMantineTheme();
  const contextPropsPayload = theme.components[component]?.defaultProps;
  const contextProps = typeof contextPropsPayload === "function" ? contextPropsPayload(theme) : contextPropsPayload;
  return { ...defaultProps101, ...contextProps, ...filterProps(props) };
}
...
function resolveVars({
  ...
  return mergeVars([
    headless ? {} : varsResolver51?.(theme, props, stylesCtx),
...
function getStyle({
  ...
  return {
    ...
    ...resolveVars({ theme, props, stylesCtx, vars, varsResolver: varsResolver51, selector, themeName, headless }),
...
function polymorphicFactory(ui) {
  const Component = (0, import_react45.forwardRef)(ui);
  Component.withProps = (fixedProps) => {
    const Extended = (0, import_react45.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(Component, { ...fixedProps, ...props, ref }));
    Extended.extend = Component.extend;
    Extended.displayName = `WithProps(${Component.displayName})`;
    return Extended;
  };
...
"use client";
var DirectionContext = (0, import_react46.createContext)({
  dir: "ltr",
  toggleDirection: () => {
  },
  setDirection: () => {
...
function useDirection() {
  return (0, import_react46.useContext)(DirectionContext);
}
...
// node_modules/@mantine/core/esm/components/Loader/loaders/Bars.mjs
"use client";
var Bars = (0, import_react47.forwardRef)(({ className, ...others }, ref) => /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)(Box, {
  component: "span",
...
"use client";
var Dots = (0, import_react48.forwardRef)(({ className, ...others }, ref) => /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)(Box, {
  component: "span",
...
"use client";
var Oval = (0, import_react49.forwardRef)(({ className, ...others }, ref) => /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(Box, { component: "span", className: clsx_default(classes.ovalLoader, className), ...others, ref }));
...
var Loader = factory((_props, ref) => {
  ...
  if (children) {
    return /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(Box, { ...getStyles2("root"), ref, ...others, children });
  }
...
function useTransition({
  ...
  const transitionTimeoutRef = (0, import_react51.useRef)(-1);
  const delayTimeoutRef = (0, import_react51.useRef)(-1);
  const rafRef = (0, import_react51.useRef)(-1);
...
var ActionIconGroupSection = factory((_props, ref) => {
  const props = useProps("ActionIconGroupSection", defaultProps4, _props);
  const {
    className,
    style,
    classNames,
    ...
    autoContrast,
    ...others
  } = useProps("ActionIconGroupSection", defaultProps4, _props);
  const getStyles2 = useStyles({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(Box, { ...getStyles2("groupSection"), ref, variant, ...others });
});
...
var ActionIcon = polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime40.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(Transition, { mounted: !!loading, transition: "slide-down", duration: 150, children: (transitionStyles) => /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(Box, { component: "span", ...getStyles2("loader", { style: transitionStyles }), "aria-hidden": true, children: /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(Loader, { color: "var(--ai-color)", size: "calc(var(--ai-size) * 0.55)", ...loaderProps }) }) }),
        /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(Box, { component: "span", mod: { loading }, ...getStyles2("icon"), children })
      ]
    }
  );
});
...
function filterFalsyChildren(children) {
  return import_react57.Children.toArray(children).filter(Boolean);
}
...
"use client";
var CloseIcon = (0, import_react59.forwardRef)(
  ({ size: size4 = "var(--cb-icon-size, 70%)", style, ...others }, ref) => /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(
    "svg",
    {
      viewBox: "0 0 15 15",
      fill: "none",
...
var CloseButton = polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        icon || /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(CloseIcon, {}),
        children
      ]
    }
  );
...
"use client";
var classes6 = { "root": "m_66836ed3", "wrapper": "m_a5d60502", "body": "m_667c2793", "title": "m_6a03f287", "label": "m_698f4f23", "icon": "m_667f2a6a", "message": "m_7fa78076", "closeButton": "m_87f54839" };
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(
    Box,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)("div", {
        ...getStyles2("wrapper"),
        children: [
          icon && /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("div", { ...getStyles2("icon"), children: icon }),
          /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)("div", {
            ...getStyles2("body"),
            children: [
              title && /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("div", { ...getStyles2("title"), "data-with-close-button": withCloseButton || void 0, children: /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("span", { id: titleId, ...getStyles2("label"), children: title }) }),
              children && /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("div", { id: bodyId, ...getStyles2("message"), "data-variant": variant, children })
            ]
          }),
          withCloseButton && /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(
            CloseButton,
            {
...
function createSafeContext(errorMessage) {
  ...
  const Provider = ({ children, value }) => /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(Context.Provider, { value, children });
...
"use client";
var classes8 = { "root": "m_89ab340", "navbar": "m_45252eee", "aside": "m_9cdde9a", "header": "m_3b16f56b", "main": "m_8983817", "footer": "m_3840c879", "section": "m_6dcfc7c7" };
...
var AppShellFooter = factory((_props, ref) => {
  const props = useProps("AppShellFooter", defaultProps11, _props);
  const {
    classNames,
    className,
    style,
...
var AppShellHeader = factory((_props, ref) => {
  const props = useProps("AppShellHeader", defaultProps12, _props);
  const {
    classNames,
    className,
    style,
...
var AppShellMain = factory((_props, ref) => {
  const props = useProps("AppShellMain", defaultProps13, _props);
...
function AppShellMediaStyles({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime59.jsx)(InlineStyles, { media, styles: baseStyles, selector: ctx.cssVariablesSelector });
}
...
var AppShellNavbar = factory((_props, ref) => {
  const props = useProps("AppShellNavbar", defaultProps14, _props);
  const {
    classNames,
    className,
    style,
...
var AppShellSection = polymorphicFactory((_props, ref) => {
  const props = useProps("AppShellSection", defaultProps15, _props);
...
function useResizing({ transitionDuration, disabled }) {
  const [resizing, setResizing] = (0, import_react80.useState)(true);
  const resizingTimeout = (0, import_react80.useRef)(-1);
  const disabledTimeout = (0, import_react80.useRef)(-1);
  useWindowEvent("resize", () => {
    setResizing(true);
    clearTimeout(resizingTimeout.current);
    resizingTimeout.current = window.setTimeout(
      () => (0, import_react80.startTransition)(() => {
        setResizing(false);
      }),
      200
    );
...
var AppShell = factory((_props, ref) => {
  const props = useProps("AppShell", defaultProps16, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime62.jsxs)(AppShellProvider, {
...
function createOptionalContext(initialValue = null) {
  const Context = (0, import_react82.createContext)(initialValue);
  const useOptionalContext = () => (0, import_react82.useContext)(Context);
  const Provider = ({ children, value }) => /* @__PURE__ */ (0, import_jsx_runtime63.jsx)(Context.Provider, { value, children });
...
"use client";
var classes9 = { "wrapper": "m_6c018570", "input": "m_8fb7ebe7", "section": "m_82577fc2", "placeholder": "m_88bacfd0", "root": "m_46b77525", "label": "m_8fdc1311", "required": "m_78a94662", "error": "m_8f816625", "description": "m_fe47ce59" };
...
var InputLabel = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime70.jsxs)(
    Box,
    {
      ...
      children: [
        children,
        required && /* @__PURE__ */ (0, import_jsx_runtime70.jsx)("span", { ...getStyles2("required"), "aria-hidden": true, children: " *" })
      ]
    }
  );
});
...
var InputWrapper = factory((_props, ref) => {
  ...
  const _label = label && /* @__PURE__ */ (0, import_jsx_runtime72.jsx)(
    InputLabel,
    {
      labelElement,
      id: labelId,
  ...
  const _description = hasDescription && /* @__PURE__ */ (0, import_jsx_runtime72.jsx)(
    InputDescription,
    {
      ...descriptionProps,
      ...sharedProps,
  ...
  const _input = /* @__PURE__ */ (0, import_jsx_runtime72.jsx)(import_react91.Fragment, { children: inputContainer(children) }, "input");
  const _error = hasError && /* @__PURE__ */ (0, import_react91.createElement)(
    InputError,
    {
      ...errorProps,
      ...sharedProps,
...
var Input = polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime73.jsx)(InputContext, { value: { size: size4 || "sm" }, children: /* @__PURE__ */ (0, import_jsx_runtime73.jsxs)(
    Box,
    {
      ...getStyles2("wrapper"),
      ...styleProps,
      ...
      size: size4,
      children: [
        leftSection && /* @__PURE__ */ (0, import_jsx_runtime73.jsx)(
          "div",
          {
            ...leftSectionProps,
            "data-position": "left",
        ...
        _rightSection && /* @__PURE__ */ (0, import_jsx_runtime73.jsx)(
          "div",
          {
            ...rightSectionProps,
            "data-position": "right",
...
"use client";
var classes10 = { "root": "m_5f75b09e", "body": "m_5f6e695e", "labelWrapper": "m_d3ea56bb", "label": "m_8ee546b8", "description": "m_328f68c0", "error": "m_8e8a99cc" };

// node_modules/@mantine/core/esm/components/InlineInput/InlineInput.mjs
"use client";
var InlineInputClasses = classes10;
var InlineInput = (0, import_react93.forwardRef)(
  ({
    __staticSelector,
    __stylesApiProps,
    className,
      ...
      Box,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime74.jsxs)(
          Box,
          {
            ...
            children: [
              children,
              /* @__PURE__ */ (0, import_jsx_runtime74.jsxs)("div", {
                ...
                children: [
                  ...
                  description && /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(Input.Description, { size: size4, __inheritStyles: false, ...getStyles2("description"), children: description }),
                  error2 && typeof error2 !== "boolean" && /* @__PURE__ */ (0, import_jsx_runtime74.jsx)(Input.Error, { size: size4, __inheritStyles: false, ...getStyles2("error"), children: error2 })
                ]
              })
            ]
          }
...
var useCheckboxGroupContext = () => (0, import_react94.useContext)(CheckboxGroupContext);
...
var varsResolver15 = createVarsResolver((_, { radius }) => ({
  card: {
    "--card-radius": getRadius(radius)
  }
}));
var CheckboxCard = factory((_props, ref) => {
  const props = useProps("CheckboxCard", defaultProps24, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime76.jsx)(CheckboxCardProvider, { value: { checked: _value }, children: /* @__PURE__ */ (0, import_jsx_runtime76.jsx)(
    UnstyledButton,
    {
      ref,
...
CheckboxCard.classes = classes11;
...
function InputsGroupFieldset({ children, role }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime77.jsx)("div", { role, "aria-labelledby": ctx.labelId, "aria-describedby": ctx.describedBy, children });
}
...
var CheckboxGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size4, wrapperProps, children, readOnly, ...others } = useProps("CheckboxGroup", defaultProps25, props);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: [],
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime78.jsx)(CheckboxGroupProvider, { value: { value: _value, onChange: handleChange, size: size4 }, children: /* @__PURE__ */ (0, import_jsx_runtime78.jsx)(
    Input.Wrapper,
    {
      size: size4,
      ref,
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime78.jsx)(InputsGroupFieldset, { role: "group", children })
    }
  ) });
});
  ...
  if (indeterminate) {
    return /* @__PURE__ */ (0, import_jsx_runtime79.jsx)(
      "svg",
      {
        ...
        "aria-hidden": true,
        ...others,
        children: /* @__PURE__ */ (0, import_jsx_runtime79.jsx)("rect", { width: "32", height: "6", fill: "currentColor", rx: "3" })
      }
    );
  }
  return /* @__PURE__ */ (0, import_jsx_runtime79.jsx)(CheckIcon, { ...others });
}

// node_modules/@mantine/core/esm/components/Checkbox/CheckboxIndicator/CheckboxIndicator.module.css.mjs
"use client";
var classes12 = { "indicator": "m_5e5256ee", "icon": "m_1b1c543a", "indicator--outline": "m_76e20374" };
...
var CheckboxIndicator = factory((_props, ref) => {
  const props = useProps("CheckboxIndicator", defaultProps26, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(
    Box,
    {
      ...
      ...others,
      children: /* @__PURE__ */ (0, import_jsx_runtime80.jsx)(Icon, { indeterminate, ...getStyles2("icon") })
    }
  );
});
CheckboxIndicator.displayName = "@mantine/core/CheckboxIndicator";
CheckboxIndicator.classes = classes12;

// node_modules/@mantine/core/esm/components/Checkbox/Checkbox.module.css.mjs
"use client";
var classes13 = { "root": "m_bf2d988c", "inner": "m_26062bec", "input": "m_26063560", "icon": "m_bf295423", "input--outline": "m_215c4542" };
...
var Checkbox = factory((_props, forwardedRef) => {
  const props = useProps("Checkbox", defaultProps27, _props);
  const {
    classNames,
    className,
    style,
  ...
  const fallbackRef = (0, import_react101.useRef)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime81.jsx)(
    InlineInput,
    {
      ...
      ...styleProps,
      ...wrapperProps,
      children: /* @__PURE__ */ (0, import_jsx_runtime81.jsxs)(Box, {
        ...getStyles2("inner"),
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime81.jsx)(Icon, { indeterminate, ...getStyles2("icon") })
        ]
      })
    }
  );
});
Checkbox.classes = { ...classes13, ...InlineInputClasses };
...
"use client";
var AvatarGroupContext = (0, import_react102.createContext)(null);
var AvatarGroupProvider = AvatarGroupContext.Provider;
function useAvatarGroupContext() {
  const ctx = (0, import_react102.useContext)(AvatarGroupContext);
  return { withinGroup: !!ctx };
}

// node_modules/@mantine/core/esm/components/Avatar/Avatar.module.css.mjs
"use client";
var classes14 = { "group": "m_11def92b", "root": "m_f85678b6", "image": "m_11f8ac07", "placeholder": "m_104cd71f" };

// node_modules/@mantine/core/esm/components/Avatar/AvatarGroup/AvatarGroup.mjs
"use client";
var defaultProps28 = {};
var varsResolver18 = createVarsResolver((_, { spacing }) => ({
  group: {
    "--ag-spacing": getSpacing(spacing)
  }
}));
var AvatarGroup = factory((_props, ref) => {
  const props = useProps("AvatarGroup", defaultProps28, _props);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime82.jsx)(AvatarGroupProvider, { value: true, children: /* @__PURE__ */ (0, import_jsx_runtime82.jsx)(Box, { ref, ...getStyles2("group"), ...others }) });
});
AvatarGroup.classes = classes14;
...
var Avatar = polymorphicFactory((_props, ref) => {
  const props = useProps("Avatar", defaultProps29, _props);
  const {
    classNames,
    className,
    style,
  ...
  const [error2, setError] = (0, import_react104.useState)(!src);
  const getStyles2 = useStyles({
    name: "Avatar",
    props,
    classes: classes14,
  ...
  (0, import_react104.useEffect)(() => setError(!src), [src]);
  return /* @__PURE__ */ (0, import_jsx_runtime84.jsx)(
    Box,
    {
      ...
      ref,
      ...others,
      children: error2 ? /* @__PURE__ */ (0, import_jsx_runtime84.jsx)("span", { ...getStyles2("placeholder"), title: alt, children: children || typeof name === "string" && getInitials(name) || /* @__PURE__ */ (0, import_jsx_runtime84.jsx)(AvatarPlaceholderIcon, {}) }) : /* @__PURE__ */ (0, import_jsx_runtime84.jsx)(
        "img",
        {
          ...imageProps,
          ...getStyles2("image"),
...
"use client";
var classes15 = { "root": "m_347db0ec", "root--dot": "m_fbd81e3d", "label": "m_5add502a", "section": "m_91fdda9b" };
...
var Badge = polymorphicFactory((_props, ref) => {
  const props = useProps("Badge", defaultProps30, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime85.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        leftSection && /* @__PURE__ */ (0, import_jsx_runtime85.jsx)("span", { ...getStyles2("section"), "data-position": "left", children: leftSection }),
        /* @__PURE__ */ (0, import_jsx_runtime85.jsx)("span", { ...getStyles2("label"), children }),
        rightSection && /* @__PURE__ */ (0, import_jsx_runtime85.jsx)("span", { ...getStyles2("section"), "data-position": "right", children: rightSection })
      ]
    }
  );
});
Badge.classes = classes15;
...
"use client";
var classes16 = { "root": "m_77c9d27d", "inner": "m_80f1301b", "label": "m_811560b9", "section": "m_a74036a", "loader": "m_a25b86ee", "group": "m_80d6d844", "groupSection": "m_70be2a01" };
...
var varsResolver21 = createVarsResolver((_, { borderWidth }) => ({
  group: { "--button-border-width": rem(borderWidth) }
}));
var ButtonGroup = factory((_props, ref) => {
  const props = useProps("ButtonGroup", defaultProps31, _props);
  const {
    className,
    style,
    classNames,
    ...
    mod,
    ...others
  } = useProps("ButtonGroup", defaultProps31, _props);
  const getStyles2 = useStyles({
    name: "ButtonGroup",
    props,
    classes: classes16,
...
var ButtonGroupSection = factory((_props, ref) => {
  const props = useProps("ButtonGroupSection", defaultProps32, _props);
  const {
    className,
    style,
    classNames,
    ...
    autoContrast,
    ...others
  } = useProps("ButtonGroupSection", defaultProps32, _props);
  const getStyles2 = useStyles({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime87.jsx)(Box, { ...getStyles2("groupSection"), ref, variant, ...others });
});
...
var Button = polymorphicFactory((_props, ref) => {
  const props = useProps("Button", defaultProps33, _props);
  const {
    style,
    vars,
    className,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime88.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime88.jsxs)("span", {
          ...getStyles2("inner"),
          children: [
...
"use client";
var classes17 = { "root": "m_1b7284a3" };

// node_modules/@mantine/core/esm/components/Paper/Paper.mjs
"use client";
var defaultProps34 = {};
var varsResolver24 = createVarsResolver((_, { radius, shadow }) => ({
  root: {
...
var Paper = polymorphicFactory((_props, ref) => {
  const props = useProps("Paper", defaultProps34, _props);
  const {
    classNames,
    className,
    style,
...
"use client";
var classes18 = { "root": "m_e615b15f", "section": "m_599a2148" };

// node_modules/@mantine/core/esm/components/Card/CardSection/CardSection.mjs
"use client";
var defaultProps35 = {};
var CardSection = polymorphicFactory((_props, ref) => {
  const props = useProps("CardSection", defaultProps35, _props);
...
"use client";
var defaultProps36 = {};
var varsResolver25 = createVarsResolver((_, { padding }) => ({
  root: {
    "--card-padding": getSpacing(padding)
  }
}));
var Card = polymorphicFactory((_props, ref) => {
  const props = useProps("Card", defaultProps36, _props);
  ...
  const _children = import_react112.Children.toArray(children);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime92.jsx)(CardProvider, { value: { getStyles: getStyles2 }, children: /* @__PURE__ */ (0, import_jsx_runtime92.jsx)(Paper, { ref, unstyled, ...getStyles2("root"), ...others, children: content }) });
});
...
"use client";
var classes19 = { "root": "m_4451eb3a" };

// node_modules/@mantine/core/esm/components/Center/Center.mjs
"use client";
var defaultProps37 = {};
var Center = polymorphicFactory((_props, ref) => {
  const props = useProps("Center", defaultProps37, _props);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime93.jsx)(Box, { ref, mod: [{ inline: inline4 }, mod], ...getStyles2("root"), ...others });
});
...
"use client";
var classes20 = { "root": "m_3eebeb36", "label": "m_9e365f20" };
...
var varsResolver26 = createVarsResolver((theme, { color, variant, size: size4 }) => ({
  root: {
...
var Divider = factory((_props, ref) => {
  const props = useProps("Divider", defaultProps38, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime94.jsx)(
    Box,
    {
      ...
      ...others,
      role: "separator",
      children: label && /* @__PURE__ */ (0, import_jsx_runtime94.jsx)(Box, { component: "span", mod: { position: labelPosition }, ...getStyles2("label"), children: label })
    }
  );
});
...
var FileButton = (0, import_react115.forwardRef)(
  (props, ref) => {
    const {
      onChange,
      children,
      ...
      inputProps,
      ...others
    } = useProps("FileButton", defaultProps39, props);
...
"use client";
var classes21 = { "container": "m_8478a6da", "root": "m_410352e9", "inner": "m_dee7bd2f", "col": "m_96bdd299" };
...
var GridCol = factory((_props, ref) => {
  const props = useProps("GridCol", defaultProps40, _props);
  const { classNames, className, style, styles, vars, span, order, offset: offset4, ...others } = props;
  const ctx = useGridContext();
  const responsiveClassName = useRandomClassName();
  return /* @__PURE__ */ (0, import_jsx_runtime98.jsxs)(import_jsx_runtime98.Fragment, {
    children: [
...
var varsResolver27 = createVarsResolver((_, { justify, align, overflow }) => ({
  root: {
...
var Grid = factory((_props, ref) => {
  const props = useProps("Grid", defaultProps41, _props);
  const {
    classNames,
    className,
    style,
  ...
  if (type === "container" && breakpoints) {
    return /* @__PURE__ */ (0, import_jsx_runtime100.jsxs)(GridProvider, {
      value: { getStyles: getStyles2, grow, columns: columns || 12, breakpoints, type },
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime100.jsx)(GridVariables, { selector: `.${responsiveClassName}`, ...props }),
        /* @__PURE__ */ (0, import_jsx_runtime100.jsx)("div", { ...getStyles2("container"), children: /* @__PURE__ */ (0, import_jsx_runtime100.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others, children: /* @__PURE__ */ (0, import_jsx_runtime100.jsx)("div", { ...getStyles2("inner"), children }) }) })
      ]
    });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime100.jsxs)(GridProvider, {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime100.jsx)(GridVariables, { selector: `.${responsiveClassName}`, ...props }),
      /* @__PURE__ */ (0, import_jsx_runtime100.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others, children: /* @__PURE__ */ (0, import_jsx_runtime100.jsx)("div", { ...getStyles2("inner"), children }) })
    ]
  });
});
Grid.classes = classes21;
...
var useLatest = function useLatest2(value) {
  var ref = import_react122.default.useRef(value);
  index(function() {
    ref.current = value;
  });
  return ref;
...
var useComposedRef = function useComposedRef2(libRef, userRef) {
  var prevUserRef = import_react123.default.useRef();
  return import_react123.default.useCallback(function(instance) {
...
"use client";
function useInputProps(component, defaultProps101, _props) {
  const props = useProps(component, defaultProps101, _props);
  const {
    label,
    description,
    error: error2,
...
var InputBase = polymorphicFactory((props, ref) => {
  const { inputProps, wrapperProps, ...others } = useInputProps("InputBase", defaultProps42, props);
  return /* @__PURE__ */ (0, import_jsx_runtime102.jsx)(Input.Wrapper, { ...wrapperProps, children: /* @__PURE__ */ (0, import_jsx_runtime102.jsx)(Input, { ...inputProps, ...others, ref }) });
});
...
var Portal = factory((props, ref) => {
  const { children, target, reuseTargetNode, ...others } = useProps("Portal", defaultProps44, props);
  const [mounted, setMounted] = (0, import_react127.useState)(false);
  ...
  return (0, import_react_dom2.createPortal)(/* @__PURE__ */ (0, import_jsx_runtime104.jsx)(import_jsx_runtime104.Fragment, { children }), nodeRef.current);
});
...
var OptionalPortal = factory(
  ({ withinPortal = true, children, ...others }, ref) => {
    ...
    if (env === "test" || !withinPortal) {
      return /* @__PURE__ */ (0, import_jsx_runtime105.jsx)(import_jsx_runtime105.Fragment, { children });
    }
    return /* @__PURE__ */ (0, import_jsx_runtime105.jsx)(Portal, { ref, ...others, children });
  }
);
...
function useLockScroll({ opened, transitionDuration }) {
  const [shouldLockScroll, setShouldLockScroll] = (0, import_react130.useState)(opened);
  const timeout = (0, import_react130.useRef)(-1);
...
function useModal({
  ...
  const _id = useId(id);
  const [titleMounted, setTitleMounted] = (0, import_react131.useState)(false);
  const [bodyMounted, setBodyMounted] = (0, import_react131.useState)(false);
...
// node_modules/@mantine/core/esm/components/ModalBase/ModalBase.mjs
"use client";
var ModalBase = (0, import_react132.forwardRef)(
  ({
    keepMounted,
    opened,
    onClose,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime107.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: /* @__PURE__ */ (0, import_jsx_runtime107.jsx)(
      ModalBaseProvider,
      {
        value: {
          opened,
...
"use client";
var classes22 = { "title": "m_615af6c9", "header": "m_b5489c3c", "inner": "m_60c222c7", "content": "m_fd1ab0aa", "close": "m_606cb269", "body": "m_5df29311" };

// node_modules/@mantine/core/esm/components/ModalBase/ModalBaseBody.mjs
"use client";
var ModalBaseBody = (0, import_react134.forwardRef)(
  ({ className, ...others }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime108.jsx)(
      Box,
      {
        ...
        ...others,
        id: bodyId,
        className: clsx_default({ [classes22.body]: !ctx.unstyled }, className)
      }
    );
  }
);
...
"use client";
var ModalBaseCloseButton = (0, import_react135.forwardRef)(
  ({ className, onClick, ...others }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime109.jsx)(
      CloseButton,
      {
        ...
        className: clsx_default({ [classes22.close]: !ctx.unstyled }, className),
...
function isElement(value) {
  ...
  if (typeof value === "object") {
    if (value.type === import_react136.Fragment) {
      return false;
    }
    return true;
  }
...
"use client";
var classes23 = { "root": "m_515a97f8" };

// node_modules/@mantine/core/esm/components/VisuallyHidden/VisuallyHidden.mjs
"use client";
var defaultProps45 = {};
var VisuallyHidden = factory((_props, ref) => {
  const props = useProps("VisuallyHidden", defaultProps45, _props);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime110.jsx)(Box, { component: "span", ref, ...getStyles2("root"), ...others });
});
VisuallyHidden.classes = classes23;
...
function FocusTrapInitialFocus(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime111.jsx)(VisuallyHidden, { tabIndex: -1, "data-autofocus": true, ...props });
}
...
// node_modules/@mantine/core/esm/components/ModalBase/ModalBaseContent.mjs
"use client";
var ModalBaseContent = (0, import_react139.forwardRef)(
  ({ transitionProps, className, innerProps, onKeyDown, style, ...others }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime112.jsx)(
      Transition,
      {
        ...
        ...transitionProps,
        children: (transitionStyles) => /* @__PURE__ */ (0, import_jsx_runtime112.jsx)(
          "div",
          {
            ...innerProps,
            className: clsx_default({ [classes22.inner]: !ctx.unstyled }, innerProps.className),
            children: /* @__PURE__ */ (0, import_jsx_runtime112.jsx)(FocusTrap, { active: ctx.opened && ctx.trapFocus, innerRef: ref, children: /* @__PURE__ */ (0, import_jsx_runtime112.jsx)(
              Paper,
              {
                ...others,
                component: "section",
                ...
                className: clsx_default({ [classes22.content]: !ctx.unstyled }, className),
                unstyled: ctx.unstyled,
...
"use client";
var ModalBaseHeader = (0, import_react140.forwardRef)(
  ({ className, ...others }, ref) => {
    const ctx = useModalBaseContext();
    return /* @__PURE__ */ (0, import_jsx_runtime113.jsx)(
      Box,
      {
        component: "header",
        ref,
        className: clsx_default({ [classes22.header]: !ctx.unstyled }, className),
        ...others
      }
    );
  }
...
var Overlay = polymorphicFactory((_props, ref) => {
  const props = useProps("Overlay", defaultProps46, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime114.jsx)(Box, { ref, ...getStyles2("root"), mod: [{ center, fixed }, mod], ...others, children });
});
Overlay.classes = classes24;
...
// node_modules/@mantine/core/esm/components/ModalBase/ModalBaseOverlay.mjs
"use client";
var ModalBaseOverlay = (0, import_react142.forwardRef)(
  ({ onClick, transitionProps, style, visible: visible2, ...others }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime115.jsx)(
      Transition,
      {
        ...
        ...transition,
        transition: "fade",
        children: (transitionStyles) => /* @__PURE__ */ (0, import_jsx_runtime115.jsx)(
          Overlay,
          {
            ref,
            fixed: true,
...
// node_modules/@mantine/core/esm/components/ModalBase/ModalBaseTitle.mjs
"use client";
var ModalBaseTitle = (0, import_react144.forwardRef)(
  ({ className, ...others }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime116.jsx)(
      Box,
      {
        component: "h2",
        ref,
        className: clsx_default({ [classes22.title]: !ctx.unstyled }, className),
        ...others,
        id
      }
    );
...
"use client";
var classes25 = { "root": "m_9df02822", "content": "m_54c44539", "inner": "m_1f958f16", "header": "m_d0e2b9cd" };
...
ModalCloseButton.classes = classes25;
...
function NativeScrollArea({ children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime120.jsx)(import_jsx_runtime120.Fragment, { children });
}
...
ModalContent.classes = classes25;
...
ModalOverlay.classes = classes25;
...
var index3 = isClient ? import_react151.useLayoutEffect : noop3;
...
var index4 = typeof document !== "undefined" ? import_react152.useLayoutEffect : import_react152.useEffect;
...
function useLatestRef2(value) {
  const ref = (0, import_react152.useRef)(value);
  index4(() => {
    ref.current = value;
  });
  return ref;
...
function FloatingDelayGroup(props) {
  ...
  return /* @__PURE__ */ React13.createElement(FloatingDelayGroupContext.Provider, {
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaCorner/ScrollAreaCorner.mjs
"use client";
var Corner = (0, import_react154.forwardRef)((props, ref) => {
  ...
  return hasSize ? /* @__PURE__ */ (0, import_jsx_runtime125.jsx)("div", { ...others, ref, style: { ...style, width, height } }) : null;
});
var ScrollAreaCorner = (0, import_react154.forwardRef)((props, ref) => {
  const ctx = useScrollAreaContext();
  const hasBothScrollbarsVisible = Boolean(ctx.scrollbarX && ctx.scrollbarY);
  const hasCorner = ctx.type !== "scroll" && hasBothScrollbarsVisible;
  return hasCorner ? /* @__PURE__ */ (0, import_jsx_runtime125.jsx)(Corner, { ...props, ref }) : null;
});
...
var ScrollAreaRoot = (0, import_react155.forwardRef)((_props, ref) => {
  const props = useProps("ScrollAreaRoot", defaultProps52, _props);
  const { type, scrollHideDelay, scrollbars, ...others } = props;
  const [scrollArea, setScrollArea] = (0, import_react155.useState)(null);
  const [viewport, setViewport] = (0, import_react155.useState)(null);
  const [content, setContent] = (0, import_react155.useState)(null);
  const [scrollbarX, setScrollbarX] = (0, import_react155.useState)(null);
  const [scrollbarY, setScrollbarY] = (0, import_react155.useState)(null);
  const [cornerWidth, setCornerWidth] = (0, import_react155.useState)(0);
  const [cornerHeight, setCornerHeight] = (0, import_react155.useState)(0);
  const [scrollbarXEnabled, setScrollbarXEnabled] = (0, import_react155.useState)(false);
  const [scrollbarYEnabled, setScrollbarYEnabled] = (0, import_react155.useState)(false);
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/Scrollbar.mjs
"use client";
var Scrollbar = (0, import_react157.forwardRef)((props, forwardedRef) => {
  const {
    sizes: sizes2,
    hasThumb,
    onThumbChange,
  ...
  const [scrollbar, setScrollbar] = (0, import_react157.useState)(null);
  const composeRefs = useMergedRef(forwardedRef, (node) => setScrollbar(node));
  const rectRef = (0, import_react157.useRef)(null);
  const prevWebkitUserSelectRef = (0, import_react157.useRef)("");
  ...
  (0, import_react157.useEffect)(handleThumbPositionChange, [sizes2, handleThumbPositionChange]);
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollbarX.mjs
"use client";
var ScrollAreaScrollbarX = (0, import_react158.forwardRef)(
  (props, forwardedRef) => {
    const { sizes: sizes2, onSizesChange, style, ...others } = props;
    const ctx = useScrollAreaContext();
    const [computedStyle, setComputedStyle] = (0, import_react158.useState)();
...
"use client";
var ScrollAreaScrollbarY = (0, import_react159.forwardRef)(
  (props, forwardedRef) => {
    const { sizes: sizes2, onSizesChange, style, ...others } = props;
    const context = useScrollAreaContext();
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbarVisible.mjs
"use client";
var ScrollAreaScrollbarVisible = (0, import_react160.forwardRef)((props, forwardedRef) => {
  const { orientation = "vertical", ...scrollbarProps } = props;
  const { dir } = useDirection();
  const context = useScrollAreaContext();
  const thumbRef = (0, import_react160.useRef)(null);
  const pointerOffsetRef = (0, import_react160.useRef)(0);
  const [sizes2, setSizes] = (0, import_react160.useState)({
    content: 0,
    viewport: 0,
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbarAuto.mjs
"use client";
var ScrollAreaScrollbarAuto = (0, import_react161.forwardRef)(
  (props, ref) => {
    const context = useScrollAreaContext();
    const { forceMount, ...scrollbarProps } = props;
    const [visible2, setVisible] = (0, import_react161.useState)(false);
...
"use client";
var ScrollAreaScrollbarHover = (0, import_react162.forwardRef)(
  (props, ref) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
...
"use client";
var ScrollAreaScrollbarScroll = (0, import_react163.forwardRef)(
  (props, red) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
    const isHorizontal = props.orientation === "horizontal";
    const [state, setState] = (0, import_react163.useState)("hidden");
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbar.mjs
"use client";
var ScrollAreaScrollbar = (0, import_react164.forwardRef)(
  (props, forwardedRef) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
    ...
    return context.type === "hover" ? /* @__PURE__ */ (0, import_jsx_runtime135.jsx)(ScrollAreaScrollbarHover, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "scroll" ? /* @__PURE__ */ (0, import_jsx_runtime135.jsx)(ScrollAreaScrollbarScroll, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "auto" ? /* @__PURE__ */ (0, import_jsx_runtime135.jsx)(ScrollAreaScrollbarAuto, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "always" ? /* @__PURE__ */ (0, import_jsx_runtime135.jsx)(ScrollAreaScrollbarVisible, { ...scrollbarProps, ref: forwardedRef }) : null;
  }
);
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaThumb/ScrollAreaThumb.mjs
"use client";
var Thumb = (0, import_react165.forwardRef)((props, forwardedRef) => {
  const { style, ...others } = props;
  const scrollAreaContext = useScrollAreaContext();
  const scrollbarContext = useScrollbarContext();
  const { onThumbPositionChange } = scrollbarContext;
  const composedRef = useMergedRef(forwardedRef, (node) => scrollbarContext.onThumbChange(node));
  const removeUnlinkedScrollListenerRef = (0, import_react165.useRef)(void 0);
...
var ScrollAreaThumb = (0, import_react165.forwardRef)(
  (props, forwardedRef) => {
    const { forceMount, ...thumbProps } = props;
    const scrollbarContext = useScrollbarContext();
    if (forceMount || scrollbarContext.hasThumb) {
      return /* @__PURE__ */ (0, import_jsx_runtime136.jsx)(Thumb, { ref: forwardedRef, ...thumbProps });
    }
    return null;
  }
);
...
"use client";
var ScrollAreaViewport = (0, import_react166.forwardRef)(
  ({ children, style, ...others }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime137.jsx)(
      Box,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime137.jsx)("div", { style: { minWidth: "100%" }, ref: ctx.onContentChange, children })
      }
    );
  }
);
...
"use client";
var classes26 = { "root": "m_d57069b5", "viewport": "m_c0783ff9", "viewportInner": "m_f8f631dd", "scrollbar": "m_c44ba933", "thumb": "m_d8b5e363", "corner": "m_21657268" };
...
var ScrollArea = factory((_props, ref) => {
  ...
  const [scrollbarHovered, setScrollbarHovered] = (0, import_react167.useState)(false);
  const [verticalThumbVisible, setVerticalThumbVisible] = (0, import_react167.useState)(false);
  const [horizontalThumbVisible, setHorizontalThumbVisible] = (0, import_react167.useState)(false);
  const getStyles2 = useStyles({
    name: "ScrollArea",
    props,
    classes: classes26,
  ...
  const localViewportRef = (0, import_react167.useRef)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime138.jsxs)(
    ScrollAreaRoot,
    {
      ...
      children: [
        ...
        (scrollbars === "xy" || scrollbars === "x") && /* @__PURE__ */ (0, import_jsx_runtime138.jsx)(
          ScrollAreaScrollbar,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime138.jsx)(ScrollAreaThumb, { ...getStyles2("thumb") })
          }
        ),
        (scrollbars === "xy" || scrollbars === "y") && /* @__PURE__ */ (0, import_jsx_runtime138.jsx)(
          ScrollAreaScrollbar,
          {
            ...getStyles2("scrollbar"),
...
var ScrollAreaAutosize = factory((props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime138.jsx)(Box, { ...others, ref, style: [{ display: "flex", overflow: "auto" }, style], children: /* @__PURE__ */ (0, import_jsx_runtime138.jsx)(Box, { style: { display: "flex", flexDirection: "column", flex: 1 }, children: /* @__PURE__ */ (0, import_jsx_runtime138.jsx)(
    ScrollArea,
    {
      classNames,
      styles,
...
ScrollArea.classes = classes26;
ScrollAreaAutosize.displayName = "@mantine/core/ScrollAreaAutosize";
ScrollAreaAutosize.classes = classes26;
...
var ModalRoot = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime139.jsx)(ModalProvider, { value: { yOffset, scrollAreaComponent, getStyles: getStyles2, fullScreen }, children: /* @__PURE__ */ (0, import_jsx_runtime139.jsx)(
    ModalBase,
    {
      ref,
      ...getStyles2("root"),
...
function ModalStack({ children }) {
  const [stack, setStack] = (0, import_react170.useState)([]);
  const [maxZIndex, setMaxZIndex] = (0, import_react170.useState)(getDefaultZIndex("modal"));
...
var Modal = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime142.jsxs)(
    ModalRoot,
    {
      ...
      ...stackProps,
      children: [
        withOverlay && /* @__PURE__ */ (0, import_jsx_runtime142.jsx)(
          ModalOverlay,
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime142.jsxs)(
          ModalContent,
          {
            ...
            children: [
              hasHeader && /* @__PURE__ */ (0, import_jsx_runtime142.jsxs)(ModalHeader, {
                children: [
                  title && /* @__PURE__ */ (0, import_jsx_runtime142.jsx)(ModalTitle, { children: title }),
                  withCloseButton && /* @__PURE__ */ (0, import_jsx_runtime142.jsx)(ModalCloseButton, { ...closeButtonProps })
                ]
              }),
              /* @__PURE__ */ (0, import_jsx_runtime142.jsx)(ModalBody, { children })
            ]
          }
        )
      ]
...
function usePersistentCallback(cb) {
  var callbackRef = (0, import_react173.useRef)(cb);
  callbackRef.current = cb;
  var persistentCbRef = (0, import_react173.useRef)(function() {
    var args = [], len = arguments.length;
    while (len--)
      args[len] = arguments[len];
...
function useInternalValues(value, defaultValue, valueIsNumericString, format2, removeFormatting2, onValueChange) {
  ...
  var ref = (0, import_react173.useState)(function() {
  ...
  (0, import_react173.useMemo)(function() {
    setValues(newValues);
...
function NumberFormatBase(props) {
  ...
  var caretPositionBeforeChange = (0, import_react173.useRef)();
  var lastUpdatedValue = (0, import_react173.useRef)({ formattedValue, numAsString });
  ...
  var ref$1 = (0, import_react173.useState)(false);
  var mounted = ref$1[0];
  var setMounted = ref$1[1];
  var focusedElm = (0, import_react173.useRef)(null);
  var timeout = (0, import_react173.useRef)({
  ...
  var useIsomorphicLayoutEffect2 = typeof window !== "undefined" ? import_react173.useLayoutEffect : import_react173.useEffect;
  ...
  if (displayType === "text") {
    return renderText ? import_react173.default.createElement(import_react173.default.Fragment, null, renderText(formattedValue, otherProps) || null) : import_react173.default.createElement("span", Object.assign({}, otherProps, { ref: getInputRef }), formattedValue);
  } else if (customInput) {
    var CustomInput = customInput;
    return import_react173.default.createElement(CustomInput, Object.assign({}, inputProps, { ref: getInputRef }));
  }
  return import_react173.default.createElement("input", Object.assign({}, inputProps, { ref: getInputRef }));
}
...
function NumericFormat(props) {
  ...
  return import_react173.default.createElement(NumberFormatBase, Object.assign({}, numericFormatProps));
}
...
"use client";
var classes27 = { "root": "m_e2f5cd4e", "controls": "m_95e17d22", "control": "m_80b4b171" };
...
var varsResolver31 = createVarsResolver((_, { size: size4 }) => ({
  controls: {
...
var NumberInput = factory((_props, ref) => {
  const props = useProps("NumberInput", defaultProps57, _props);
  const {
    className,
    classNames,
    styles,
  ...
  const onStepTimeoutRef = (0, import_react174.useRef)(null);
  const stepCountRef = (0, import_react174.useRef)(0);
  ...
  const incrementRef = (0, import_react174.useRef)(noop6);
  ...
  const decrementRef = (0, import_react174.useRef)(noop6);
  ...
  const controls = /* @__PURE__ */ (0, import_jsx_runtime144.jsxs)("div", {
    ...getStyles2("controls"),
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime144.jsx)(
        UnstyledButton,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime144.jsx)(NumberInputChevron, { direction: "up" })
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime144.jsx)(
        UnstyledButton,
        {
          ...
          onPointerUp: onStepDone,
          onPointerLeave: onStepDone,
          children: /* @__PURE__ */ (0, import_jsx_runtime144.jsx)(NumberInputChevron, { direction: "down" })
        }
      )
    ]
  });
  return /* @__PURE__ */ (0, import_jsx_runtime144.jsx)(
    InputBase,
    {
      ...
      allowNegative,
      className: clsx_default(classes27.root, className),
      size: size4,
      ...others,
      readOnly,
      disabled,
...
NumberInput.classes = { ...InputBase.classes, ...classes27 };
...
"use client";
var classes28 = { "root": "m_db6d6462", "section": "m_2242eb65", "stripes-animation": "m_81a374bd", "label": "m_91e40b74" };
...
var ProgressRoot = factory((_props, ref) => {
  const props = useProps("ProgressRoot", defaultProps59, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime147.jsx)(ProgressProvider, { value: { getStyles: getStyles2, autoContrast }, children: /* @__PURE__ */ (0, import_jsx_runtime147.jsx)(Box, { ref, ...getStyles2("root"), ...others }) });
});
...
var ProgressSection = factory((props, ref) => {
  const {
    ...
    mod,
    ...others
  } = useProps("ProgressSection", defaultProps60, props);
  const ctx = useProgressContext();
  const theme = useMantineTheme();
  const ariaAttributes = withAria ? {
    role: "progressbar",
...
var Progress = factory((_props, ref) => {
  const props = useProps("Progress", defaultProps61, _props);
  const {
    value,
    classNames,
    styles,
...
var varsResolver33 = createVarsResolver((_, { radius }) => ({
  card: {
    "--card-radius": getRadius(radius)
  }
}));
var RadioCard = factory((_props, ref) => {
  const props = useProps("RadioCard", defaultProps62, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime152.jsx)(RadioCardProvider, { value: { checked: _checked }, children: /* @__PURE__ */ (0, import_jsx_runtime152.jsx)(
    UnstyledButton,
    {
      ref,
...
var RadioGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size4, wrapperProps, children, name, readOnly, ...others } = useProps("RadioGroup", defaultProps63, props);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime153.jsx)(RadioGroupProvider, { value: { value: _value, onChange: handleChange, size: size4, name: _name }, children: /* @__PURE__ */ (0, import_jsx_runtime153.jsx)(
    Input.Wrapper,
    {
      size: size4,
      ref,
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime153.jsx)(InputsGroupFieldset, { role: "radiogroup", children })
    }
  ) });
});
...
function RadioIcon({ size: size4, style, ...others }) {
  return /* @__PURE__ */ (0, import_jsx_runtime154.jsx)(
    "svg",
    {
      ...
      "aria-hidden": true,
      ...others,
      children: /* @__PURE__ */ (0, import_jsx_runtime154.jsx)("circle", { cx: "2.5", cy: "2.5", r: "2.5", fill: "currentColor" })
    }
  );
}
...
"use client";
var classes30 = { "indicator": "m_717d7ff6", "icon": "m_3e4da632", "indicator--outline": "m_2980836c" };
...
var RadioIndicator = factory((_props, ref) => {
  const props = useProps("RadioIndicator", defaultProps64, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime155.jsx)(
    Box,
    {
      ...
      mod: [{ checked: _checked, disabled }, mod],
      ...others,
      children: /* @__PURE__ */ (0, import_jsx_runtime155.jsx)(Icon, { ...getStyles2("icon") })
    }
  );
});
RadioIndicator.displayName = "@mantine/core/RadioIndicator";
RadioIndicator.classes = classes30;

// node_modules/@mantine/core/esm/components/Radio/Radio.module.css.mjs
"use client";
var classes31 = { "root": "m_f3f1af94", "inner": "m_89c4f5e4", "icon": "m_f3ed6b2b", "radio": "m_8a3dbb89", "radio--outline": "m_1bfe9d39" };
...
var Radio = factory((_props, ref) => {
  const props = useProps("Radio", defaultProps65, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime156.jsx)(
    InlineInput,
    {
      ...
      ...styleProps,
      ...wrapperProps,
      children: /* @__PURE__ */ (0, import_jsx_runtime156.jsxs)(Box, {
        ...getStyles2("inner"),
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime156.jsx)(Icon, { ...getStyles2("icon"), "aria-hidden": true })
        ]
      })
    }
  );
});
Radio.classes = classes31;
...
function StarIcon(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime158.jsx)(
    "svg",
    {
      ...
      ...others,
      children: /* @__PURE__ */ (0, import_jsx_runtime158.jsx)("path", { d: "M12 17.75l-6.172 3.245l1.179 -6.873l-5 -4.867l6.9 -1l3.086 -6.253l3.086 6.253l6.9 1l-5 4.867l1.179 6.873z" })
    }
  );
}
...
function StarSymbol({ type }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime159.jsx)(StarIcon, { ...ctx.getStyles("starSymbol"), "data-filled": type === "full" || void 0 });
}
...
function RatingItem({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime160.jsxs)(import_jsx_runtime160.Fragment, { children: [
    !readOnly && /* @__PURE__ */ (0, import_jsx_runtime160.jsx)(
      "input",
      {
        ...ctx.getStyles("input"),
      ...
      Box,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime160.jsx)(
          Box,
          {
            ...
            children: full ? _fullIcon || /* @__PURE__ */ (0, import_jsx_runtime160.jsx)(StarSymbol, { type: "full" }) : _emptyIcon || /* @__PURE__ */ (0, import_jsx_runtime160.jsx)(StarSymbol, { type: "empty" })
          }
        )
      }
    )
...
"use client";
var classes32 = { "root": "m_f8d312f2", "symbolGroup": "m_61734bb7", "starSymbol": "m_5662a89a", "input": "m_211007ba", "label": "m_21342ee4", "symbolBody": "m_fae05d6a" };
...
var varsResolver36 = createVarsResolver((theme, { size: size4, color }) => ({
  root: {
...
var Rating = factory((_props, ref) => {
  const props = useProps("Rating", defaultProps66, _props);
  const {
    classNames,
    className,
    style,
  ...
  const [hovered, setHovered] = (0, import_react189.useState)(-1);
  const [isOutside, setOutside] = (0, import_react189.useState)(true);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime161.jsx)(RatingProvider, { value: { getStyles: getStyles2 }, children: /* @__PURE__ */ (0, import_jsx_runtime161.jsx)(
    Box,
    {
...
function getRefProp(element) {
  const version = import_react190.default.version;
  if (typeof import_react190.default.version !== "string") {
    return element?.ref;
  }
...
// node_modules/@mantine/core/esm/components/Floating/FloatingArrow/FloatingArrow.mjs
"use client";
var FloatingArrow = (0, import_react191.forwardRef)(
  ({
    position,
    arrowSize,
    arrowOffset,
...
function useFloatingTooltip({
  ...
  const [opened, setOpened] = (0, import_react192.useState)(defaultOpened);
  const boundaryRef = (0, import_react192.useRef)(null);
  ...
  const handleMouseMove = (0, import_react192.useCallback)(
    ({ clientX, clientY }) => {
...
"use client";
var classes33 = { "tooltip": "m_1b3c8819", "arrow": "m_f898399f" };
...
var TooltipFloating = factory((_props, ref) => {
  const props = useProps("TooltipFloating", defaultProps67, _props);
  const {
    children,
    refProp,
    withinPortal,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime163.jsxs)(import_jsx_runtime163.Fragment, {
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime163.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: /* @__PURE__ */ (0, import_jsx_runtime163.jsx)(
        Box,
        {
          ...others,
          ...getStyles2("tooltip", {
      ...
      (0, import_react194.cloneElement)(children, {
        ..._childrenProps,
        [refProp]: targetRef,
        onMouseEnter,
        onMouseLeave
...
TooltipFloating.classes = classes33;
...
"use client";
var TooltipGroupContext = (0, import_react195.createContext)(false);
var TooltipGroupProvider = TooltipGroupContext.Provider;
var useTooltipGroupContext = () => (0, import_react195.useContext)(TooltipGroupContext);
...
function TooltipGroup(props) {
  const { openDelay, closeDelay, children } = useProps("TooltipGroup", defaultProps68, props);
  return /* @__PURE__ */ (0, import_jsx_runtime164.jsx)(TooltipGroupProvider, { value: true, children: /* @__PURE__ */ (0, import_jsx_runtime164.jsx)(FloatingDelayGroup, { delay: { open: openDelay, close: closeDelay }, children }) });
}
...
function useFloatingAutoUpdate({
  ...
  const [delayedUpdate, setDelayedUpdate] = (0, import_react198.useState)(0);
...
function useTooltip(settings) {
  const [uncontrolledOpened, setUncontrolledOpened] = (0, import_react200.useState)(settings.defaultOpened);
  const controlled = typeof settings.opened === "boolean";
  const opened = controlled ? settings.opened : uncontrolledOpened;
  const withinGroup = useTooltipGroupContext();
  const uid = useId();
  const onChange = (0, import_react200.useCallback)(
    (_opened) => {
...
var Tooltip = factory((_props, ref) => {
  const props = useProps("Tooltip", defaultProps69, _props);
  const {
    children,
    position,
    refProp,
    ...
    middlewares,
    ...others
  } = useProps("Tooltip", defaultProps69, props);
  const { dir } = useDirection();
  const arrowRef = (0, import_react202.useRef)(null);
  ...
  const _childrenProps = children.props;
  return /* @__PURE__ */ (0, import_jsx_runtime165.jsxs)(import_jsx_runtime165.Fragment, {
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime165.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: /* @__PURE__ */ (0, import_jsx_runtime165.jsx)(
        Transition,
        {
          ...transition,
          keepMounted,
          ...
          children: (transitionStyles) => /* @__PURE__ */ (0, import_jsx_runtime165.jsxs)(
            Box,
            {
              ...others,
      ...
      (0, import_react202.cloneElement)(
        children,
...
"use client";
var classes34 = { "dropdown": "m_88b62a41", "search": "m_985517d8", "options": "m_b2821a6e", "option": "m_92253aa5", "empty": "m_2530cd1d", "header": "m_858f94bd", "footer": "m_82b967cb", "group": "m_254f3e4f", "groupLabel": "m_2bb2e9e5", "chevron": "m_2943220b", "optionsDropdownOption": "m_390b5f4", "optionsDropdownCheckIcon": "m_8ee53fc2" };
...
var varsResolver39 = createVarsResolver((theme, { size: size4, color }) => ({
  chevron: {
...
var ComboboxChevron = factory((_props, ref) => {
  const props = useProps("ComboboxChevron", defaultProps70, _props);
...
ComboboxChevron.classes = classes34;
...
"use client";
var classes35 = { "dropdown": "m_38a85659", "arrow": "m_a31dc6c1", "overlay": "m_3d7bc908" };

// node_modules/@mantine/core/esm/components/Popover/PopoverDropdown/PopoverDropdown.mjs
"use client";
var defaultProps71 = {};
var PopoverDropdown = factory((_props, ref) => {
  const props = useProps("PopoverDropdown", defaultProps71, _props);
  const {
    className,
    style,
    vars,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime168.jsx)(OptionalPortal, { ...ctx.portalProps, withinPortal: ctx.withinPortal, children: /* @__PURE__ */ (0, import_jsx_runtime168.jsx)(
    Transition,
    {
      mounted: ctx.opened,
      ...ctx.transitionProps,
      ...
      children: (transitionStyles) => /* @__PURE__ */ (0, import_jsx_runtime168.jsx)(FocusTrap, { active: ctx.trapFocus && ctx.opened, innerRef: mergedRef, children: /* @__PURE__ */ (0, import_jsx_runtime168.jsxs)(
        Box,
        {
          ...accessibleProps,
          ...others,
...
PopoverDropdown.classes = classes35;
...
function usePopover(options) {
  ...
  const previouslyOpened = (0, import_react207.useRef)(_opened);
  const onClose = () => {
...
var varsResolver40 = createVarsResolver((_, { radius, shadow }) => ({
  dropdown: {
...
function Popover(_props) {
  const props = useProps("Popover", defaultProps73, _props);
  const {
    children,
    position,
    offset: offset4,
  ...
  const arrowRef = (0, import_react209.useRef)(null);
  const [targetNode, setTargetNode] = (0, import_react209.useState)(null);
  const [dropdownNode, setDropdownNode] = (0, import_react209.useState)(null);
  const { dir } = useDirection();
  const uid = useId(id);
  ...
  const reference = (0, import_react209.useCallback)(
    (node) => {
      setTargetNode(node);
  ...
  const floating = (0, import_react209.useCallback)(
    (node) => {
  ...
  const onExited = (0, import_react209.useCallback)(() => {
    transitionProps?.onExited?.();
    onExitTransitionEnd?.();
  }, [transitionProps?.onExited, onExitTransitionEnd]);
  const onEntered = (0, import_react209.useCallback)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime170.jsxs)(
    PopoverContextProvider,
    {
      ...
      children: [
        children,
        withOverlay && /* @__PURE__ */ (0, import_jsx_runtime170.jsx)(
          Transition,
          {
            transition: "fade",
            ...
            children: (transitionStyles) => /* @__PURE__ */ (0, import_jsx_runtime170.jsx)(OptionalPortal, { withinPortal, children: /* @__PURE__ */ (0, import_jsx_runtime170.jsx)(
              Overlay,
              {
                ...overlayProps,
                ...getStyles2("overlay", {
...
var ComboboxClearButton = (0, import_react211.forwardRef)(
  ({ size: size4, onMouseDown, onClick, onClear, ...others }, ref) => /* @__PURE__ */ (0, import_jsx_runtime172.jsx)(
    Input.ClearButton,
    {
      ref,
      tabIndex: -1,
...
ComboboxDropdown.classes = classes34;
...
var ComboboxDropdownTarget = factory((props, ref) => {
  const { children, refProp } = useProps("ComboboxDropdownTarget", defaultProps75, props);
  useComboboxContext();
  if (!isElement(children)) {
    throw new Error(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime174.jsx)(Popover.Target, { ref, refProp, children });
});
...
ComboboxEmpty.classes = classes34;
...
var ComboboxEventsTarget = factory((props, ref) => {
  const {
    ...
    autoComplete,
    ...others
  } = useProps("ComboboxEventsTarget", defaultProps77, props);
  if (!isElement(children)) {
    throw new Error(
...
ComboboxFooter.classes = classes34;
...
var ComboboxGroup = factory((props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime178.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        label && /* @__PURE__ */ (0, import_jsx_runtime178.jsx)("div", { ...ctx.getStyles("groupLabel", { classNames, styles }), children: label }),
        children
      ]
    }
  );
});
ComboboxGroup.classes = classes34;
...
ComboboxHeader.classes = classes34;
...
var ComboboxOption = factory((_props, ref) => {
  const props = useProps("ComboboxOption", defaultProps81, _props);
  const {
    classNames,
    className,
    style,
...
ComboboxOption.classes = classes34;
...
var ComboboxOptions = factory((_props, ref) => {
  const props = useProps("ComboboxOptions", defaultProps82, _props);
...
ComboboxOptions.classes = classes34;
...
var ComboboxSearch = factory((_props, ref) => {
  const props = useProps("ComboboxSearch", defaultProps83, _props);
  const {
    classNames,
    styles,
    unstyled,
...
ComboboxSearch.classes = classes34;
...
var ComboboxTarget = factory((props, ref) => {
  const {
    ...
    autoComplete,
    ...others
  } = useProps("ComboboxTarget", defaultProps84, props);
  if (!isElement(children)) {
    throw new Error(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime184.jsx)(Popover.Target, { ref: useMergedRef(ref, ctx.store.targetRef), children: clonedElement });
});
...
var varsResolver41 = createVarsResolver((_, { size: size4, dropdownPadding }) => ({
  options: {
...
function Combobox(_props) {
  const props = useProps("Combobox", defaultProps85, _props);
  const {
    classNames,
    styles,
    unstyled,
...
function Option({
  ...
  if (!isOptionsGroup(data)) {
    ...
    const check = withCheckIcon && checked && /* @__PURE__ */ (0, import_jsx_runtime186.jsx)(CheckIcon, { className: classes34.optionsDropdownCheckIcon });
    const defaultContent = /* @__PURE__ */ (0, import_jsx_runtime186.jsxs)(import_jsx_runtime186.Fragment, {
      children: [
        checkIconPosition === "left" && check,
        /* @__PURE__ */ (0, import_jsx_runtime186.jsx)("span", { children: data.label }),
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime186.jsx)(
      Combobox.Option,
      {
        ...
        className: clsx_default({ [classes34.optionsDropdownOption]: !unstyled }),
  ...
  const options = data.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime186.jsx)(
    Option,
    {
      data: item,
      value,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime186.jsx)(Combobox.Group, { label: data.group, children: options });
}
function OptionsDropdown({
  ...
  const options = filteredData.map((item) => /* @__PURE__ */ (0, import_jsx_runtime186.jsx)(
    Option,
    {
      data: item,
      withCheckIcon,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime186.jsx)(Combobox.Dropdown, { hidden: hidden2 || hiddenWhenEmpty && isEmpty, "data-composed": true, children: /* @__PURE__ */ (0, import_jsx_runtime186.jsxs)(Combobox.Options, {
    labelledBy: labelId,
    "aria-label": ariaLabel,
    children: [
      withScrollArea ? /* @__PURE__ */ (0, import_jsx_runtime186.jsx)(
        ScrollArea.Autosize,
        {
      ...
      isEmpty && nothingFoundMessage && /* @__PURE__ */ (0, import_jsx_runtime186.jsx)(Combobox.Empty, { children: nothingFoundMessage })
    ]
  }) });
}
...
var Select = factory((_props, ref) => {
  ...
  const parsedData = (0, import_react226.useMemo)(() => getParsedComboboxData(data), [data]);
  const optionsLockup = (0, import_react226.useMemo)(() => getOptionsLockup(parsedData), [parsedData]);
  const _id = useId(id);
  ...
  const clearButton = /* @__PURE__ */ (0, import_jsx_runtime187.jsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime187.jsxs)(import_jsx_runtime187.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime187.jsxs)(
      Combobox,
      {
        ...
        ...comboboxProps,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime187.jsx)(Combobox.Target, { targetType: searchable ? "input" : "button", autoComplete, children: /* @__PURE__ */ (0, import_jsx_runtime187.jsx)(
            InputBase,
            {
              id: _id,
              ref,
              __defaultRightSection: /* @__PURE__ */ (0, import_jsx_runtime187.jsx)(
                Combobox.Chevron,
                {
                  size: size4,
                  error: error2,
...
function SimpleGridMediaVariables({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime188.jsx)(InlineStyles, { styles: baseStyles, media, selector });
}
...
function SimpleGridContainerVariables({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime188.jsx)(InlineStyles, { styles: baseStyles, container: media, selector });
}

// node_modules/@mantine/core/esm/components/SimpleGrid/SimpleGrid.module.css.mjs
"use client";
var classes36 = { "container": "m_925c2d2c", "root": "m_2415a157" };
...
var SimpleGrid = factory((_props, ref) => {
  ...
  if (type === "container") {
    return /* @__PURE__ */ (0, import_jsx_runtime189.jsxs)(import_jsx_runtime189.Fragment, {
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime189.jsx)(SimpleGridContainerVariables, { ...props, selector: `.${responsiveClassName}` }),
        /* @__PURE__ */ (0, import_jsx_runtime189.jsx)("div", { ...getStyles2("container"), children: /* @__PURE__ */ (0, import_jsx_runtime189.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others }) })
      ]
    });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime189.jsxs)(import_jsx_runtime189.Fragment, {
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime189.jsx)(SimpleGridMediaVariables, { ...props, selector: `.${responsiveClassName}` }),
      /* @__PURE__ */ (0, import_jsx_runtime189.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others })
    ]
  });
});
SimpleGrid.classes = classes36;
...
var varsResolver42 = createVarsResolver((_, { gap, align, justify }) => ({
  root: {
...
var Stack = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime190.jsx)(Box, { ref, ...getStyles2("root"), variant, ...others });
});
...
function TableDataRenderer({ data }) {
  return /* @__PURE__ */ (0, import_jsx_runtime193.jsxs)(import_jsx_runtime193.Fragment, { children: [
    data.caption && /* @__PURE__ */ (0, import_jsx_runtime193.jsx)(TableCaption, { children: data.caption }),
    data.head && /* @__PURE__ */ (0, import_jsx_runtime193.jsx)(TableThead, { children: /* @__PURE__ */ (0, import_jsx_runtime193.jsx)(TableTr, { children: data.head.map((item, index5) => /* @__PURE__ */ (0, import_jsx_runtime193.jsx)(TableTh, { children: item }, index5)) }) }),
    data.body && /* @__PURE__ */ (0, import_jsx_runtime193.jsx)(TableTbody, { children: data.body.map((row, rowIndex) => /* @__PURE__ */ (0, import_jsx_runtime193.jsx)(TableTr, { children: row.map((item, index5) => /* @__PURE__ */ (0, import_jsx_runtime193.jsx)(TableTd, { children: item }, index5)) }, rowIndex)) }),
    data.foot && /* @__PURE__ */ (0, import_jsx_runtime193.jsx)(TableTfoot, { children: /* @__PURE__ */ (0, import_jsx_runtime193.jsx)(TableTr, { children: data.foot.map((item, index5) => /* @__PURE__ */ (0, import_jsx_runtime193.jsx)(TableTh, { children: item }, index5)) }) })
  ] });
}
...
var TableScrollContainer = factory((_props, ref) => {
  const props = useProps("TableScrollContainer", defaultProps89, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime194.jsx)(
    Box,
    {
      ...
      ...others,
      children: /* @__PURE__ */ (0, import_jsx_runtime194.jsx)("div", { ...getStyles2("scrollContainerInner"), children })
    }
  );
});
...
var Table = factory((_props, ref) => {
  const props = useProps("Table", defaultProps90, _props);
  const {
    classNames,
    className,
    style,
    ...
    TableProvider,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime195.jsx)(
        Box,
        {
          ...
          ...getStyles2("table"),
          ...others,
          children: children || !!data && /* @__PURE__ */ (0, import_jsx_runtime195.jsx)(TableDataRenderer, { data })
        }
      )
    }
  );
...
"use client";
var classes39 = { "root": "m_7cda1cd6", "root--default": "m_44da308b", "root--contrast": "m_e3a01f8", "label": "m_1e0e6180", "remove": "m_ae386778", "group": "m_1dcfd90b" };

// node_modules/@mantine/core/esm/components/Pill/PillGroup/PillGroup.mjs
"use client";
var defaultProps91 = {};
var varsResolver45 = createVarsResolver((_, { gap }, { size: size4 }) => ({
  group: {
    "--pg-gap": gap !== void 0 ? getSize(gap) : getSize(size4, "pg-gap")
  }
}));
var PillGroup = factory((_props, ref) => {
  const props = useProps("PillGroup", defaultProps91, _props);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime198.jsx)(PillGroupProvider, { value: { size: _size, disabled }, children: /* @__PURE__ */ (0, import_jsx_runtime198.jsx)(Box, { ref, size: _size, ...getStyles2("group"), ...others }) });
});
PillGroup.classes = classes39;
...
var varsResolver46 = createVarsResolver((_, { radius }, { size: size4 }) => ({
  root: {
...
var Pill = factory((_props, ref) => {
  const props = useProps("Pill", defaultProps92, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime199.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime199.jsx)("span", { ...getStyles2("label"), children }),
        withRemoveButton && /* @__PURE__ */ (0, import_jsx_runtime199.jsx)(
          CloseButton,
          {
            variant: "transparent",
            radius,
...
"use client";
var classes40 = { "field": "m_45c4369d" };
...
var PillsInputField = factory((_props, ref) => {
  const props = useProps("PillsInputField", defaultProps93, _props);
  const {
    classNames,
    className,
    style,
...
PillsInputField.classes = classes40;
...
var PillsInput = factory((_props, ref) => {
  const props = useProps("PillsInput", defaultProps94, _props);
  const {
    children,
    onMouseDown,
    onClick,
  ...
  const fieldRef = (0, import_react239.useRef)(null);
  return /* @__PURE__ */ (0, import_jsx_runtime201.jsx)(PillsInputProvider, { value: { fieldRef, size: size4, disabled, hasError: !!error2, variant }, children: /* @__PURE__ */ (0, import_jsx_runtime201.jsx)(
    InputBase,
    {
      size: size4,
      error: error2,
...
var TagsInput = factory((_props, ref) => {
  const props = useProps("TagsInput", defaultProps95, _props);
  const {
    classNames,
    className,
    style,
  ...
  const inputRef = (0, import_react241.useRef)(null);
  ...
  const values2 = _value.map((item, index5) => /* @__PURE__ */ (0, import_jsx_runtime203.jsx)(
    Pill,
    {
  ...
  const clearButton = /* @__PURE__ */ (0, import_jsx_runtime203.jsx)(
    Combobox.ClearButton,
    {
      ...clearButtonProps,
      onClear: () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime203.jsxs)(import_jsx_runtime203.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime203.jsxs)(
      Combobox,
      {
        ...
        ...comboboxProps,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime203.jsx)(Combobox.DropdownTarget, { children: /* @__PURE__ */ (0, import_jsx_runtime203.jsx)(
            PillsInput,
            {
              ...styleProps,
              __staticSelector: "TagsInput",
              ...
              id: _id,
              mod,
              children: /* @__PURE__ */ (0, import_jsx_runtime203.jsxs)(Pill.Group, { disabled, unstyled, ...getStyles2("pillsList"), children: [
                values2,
                /* @__PURE__ */ (0, import_jsx_runtime203.jsx)(Combobox.EventsTarget, { autoComplete, children: /* @__PURE__ */ (0, import_jsx_runtime203.jsx)(
                  PillsInput.Field,
                  {
                    ...rest,
                    ref: _ref,
...
var TextInput = factory((props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime204.jsx)(InputBase, { component: "input", ref, ..._props, __staticSelector: "TextInput" });
});
...
var ThemeIcon = factory((_props, ref) => {
  const props = useProps("ThemeIcon", defaultProps97, _props);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime205.jsx)(Box, { ref, ...getStyles2("root"), ...others });
});
...
var varsResolver48 = createVarsResolver((_, { order, size: size4, lineClamp, textWrap }) => {
...
var varsResolver49 = createVarsResolver((_, { zIndex, position }) => ({
  root: {
...
var Affix = factory((_props, ref) => {
  const props = useProps("Affix", defaultProps99, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime208.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: /* @__PURE__ */ (0, import_jsx_runtime208.jsx)(Box, { ref, ...getStyles2("root"), ...others }) });
});
Affix.classes = classes43;
...
"use client";
var classes44 = { "root": "m_de3d2490", "colorOverlay": "m_862f3d1b", "shadowOverlay": "m_98ae7f22", "alphaOverlay": "m_95709ac0", "childrenOverlay": "m_93e74e3" };
...
var varsResolver50 = createVarsResolver((_, { radius, size: size4 }) => ({
  root: {
...
var ColorSwatch = polymorphicFactory((_props, ref) => {
  const props = useProps("ColorSwatch", defaultProps100, _props);
  const {
    classNames,
    className,
    style,
    ...
    variant,
    ...others
  } = useProps("ColorSwatch", defaultProps100, props);
  const getStyles2 = useStyles({
    name: "ColorSwatch",
    props,
    classes: classes44,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime209.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime209.jsx)("span", { ...getStyles2("alphaOverlay") }),
        withShadow && /* @__PURE__ */ (0, import_jsx_runtime209.jsx)("span", { ...getStyles2("shadowOverlay") }),
        /* @__PURE__ */ (0, import_jsx_runtime209.jsx)("span", { ...getStyles2("colorOverlay", { style: { backgroundColor: color } }) }),
        /* @__PURE__ */ (0, import_jsx_runtime209.jsx)("span", { ...getStyles2("childrenOverlay"), children })
      ]
    }
  );
});
ColorSwatch.classes = classes44;
...
//# sourceMappingURL=/build/_shared/chunk-OCP55OL5.js.map
