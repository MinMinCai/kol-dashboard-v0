...
function MantineClasses() {
  ...
  const classes43 = keys(theme.breakpoints).reduce((acc, breakpoint) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
    "style",
    {
      ...
      nonce: nonce?.(),
      dangerouslySetInnerHTML: { __html: classes43 }
    }
  );
}
...
"use client";
function useProps(component, defaultProps96, props) {
  const theme = useMantineTheme();
  const contextPropsPayload = theme.components[component]?.defaultProps;
  const contextProps = typeof contextPropsPayload === "function" ? contextPropsPayload(theme) : contextPropsPayload;
  return { ...defaultProps96, ...contextProps, ...filterProps(props) };
}
...
"use client";
function getSelectorClassName({ selector, classes: classes43, unstyled }) {
  return unstyled ? void 0 : classes43[selector];
}
...
function getVariantClassName({
  ...
  return options?.variant && !unstyled ? classes43[`${selector}--${options.variant}`] : void 0;
}
...
function getClassName({
  ...
  return clsx_default(
    ...
    getVariantClassName({ options, classes: classes43, selector, unstyled }),
    getResolvedClassNames({ selector, stylesCtx, theme, classNames, props }),
    getResolvedClassNames({ selector, stylesCtx, theme, classNames: transformedStyles, props }),
    getOptionsClassNames({ selector, stylesCtx, options, props, theme }),
    getRootClassName({ rootSelector, selector, className }),
    getSelectorClassName({ selector, classes: classes43, unstyled: unstyled || headless }),
...
function resolveVars({
  ...
  return mergeVars([
    headless ? {} : varsResolver49?.(theme, props, stylesCtx),
...
function getStyle({
  ...
  return {
    ...
    ...resolveVars({ theme, props, stylesCtx, vars, varsResolver: varsResolver49, selector, themeName, headless }),
...
"use client";
function useInputProps(component, defaultProps96, _props) {
  const props = useProps(component, defaultProps96, _props);
  const {
    label,
    description,
    error: error2,
...
var TextInput = factory((props, ref) => {
  const _props = useProps("TextInput", defaultProps91, props);
  return /* @__PURE__ */ (0, import_jsx_runtime196.jsx)(InputBase, { component: "input", ref, ..._props, __staticSelector: "TextInput" });
});
...
var ThemeIcon = factory((_props, ref) => {
  const props = useProps("ThemeIcon", defaultProps92, _props);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime197.jsx)(Box, { ref, ...getStyles2("root"), ...others });
});
ThemeIcon.classes = classes39;
...
var varsResolver46 = createVarsResolver((_, { order, size: size4, lineClamp, textWrap }) => {
...
var varsResolver47 = createVarsResolver((_, { zIndex, position }) => ({
  root: {
...
var Affix = factory((_props, ref) => {
  const props = useProps("Affix", defaultProps94, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime200.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: /* @__PURE__ */ (0, import_jsx_runtime200.jsx)(Box, { ref, ...getStyles2("root"), ...others }) });
});
Affix.classes = classes41;
...
"use client";
var classes42 = { "root": "m_de3d2490", "colorOverlay": "m_862f3d1b", "shadowOverlay": "m_98ae7f22", "alphaOverlay": "m_95709ac0", "childrenOverlay": "m_93e74e3" };
...
var varsResolver48 = createVarsResolver((_, { radius, size: size4 }) => ({
  root: {
...
var ColorSwatch = polymorphicFactory((_props, ref) => {
  const props = useProps("ColorSwatch", defaultProps95, _props);
  const {
    classNames,
    className,
    style,
    ...
    variant,
    ...others
  } = useProps("ColorSwatch", defaultProps95, props);
  const getStyles2 = useStyles({
    name: "ColorSwatch",
    props,
    classes: classes42,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime201.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime201.jsx)("span", { ...getStyles2("alphaOverlay") }),
        withShadow && /* @__PURE__ */ (0, import_jsx_runtime201.jsx)("span", { ...getStyles2("shadowOverlay") }),
        /* @__PURE__ */ (0, import_jsx_runtime201.jsx)("span", { ...getStyles2("colorOverlay", { style: { backgroundColor: color } }) }),
        /* @__PURE__ */ (0, import_jsx_runtime201.jsx)("span", { ...getStyles2("childrenOverlay"), children })
      ]
    }
  );
});
ColorSwatch.classes = classes42;
...
//# sourceMappingURL=/build/_shared/chunk-LYH654VY.js.map
