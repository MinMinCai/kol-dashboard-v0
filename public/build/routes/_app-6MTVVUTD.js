...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1773823999465.4646";
}
var navItems = [{
  to: "/dashboard",
  label: "Dashboard",
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(AppShell.Header, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Group, { justify: "space-between", align: "center", h: "100%", px: "md", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Group, { gap: "sm", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { id: "kol-sidebar-toggle-btn", type: "button", onClick: () => document.body.classList.toggle("sidebar-collapsed"), style: {
            background: "transparent",
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { id: "kol-theme-toggle-btn", type: "button", suppressHydrationWarning: true, onClick: () => {
...
//# sourceMappingURL=/build/routes/_app-6MTVVUTD.js.map
